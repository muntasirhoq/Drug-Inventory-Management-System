 ...
 * @author Sifat
 */
@WebServlet(name = "PurchaseAddItem", urlPatterns = {"/PurchaseAddItem.do"})
public class PurchaseAddItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(countMain==1)
        {
            int count = db.AddMoreItem(batchNo ,medicineID,invoiceNO, quantity);
            if(count==1)
            {
